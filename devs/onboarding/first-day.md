...
- [ ] Setup da máquina ([Ambiente de desenvolvimento](dev-environment.md))
...
> Meta do dia 1: máquina funcionando e pelo menos um projeto rodando localmente. Não é meta de código.
...
> O último item é sério. Ninguém enxerga as lacunas da documentação melhor que quem acabou de chegar. Em 60 dias você já normalizou tudo e não vê mais.

---

## Suas primeiras perguntas, respondidas

**Posso perguntar isso?** Sim. A regra dos 45 minutos vale desde o dia 1, e para você vale ainda mais.

**Vou quebrar alguma coisa?** Você não tem acesso de escrita direto em `main` nem em produção. Erre à vontade em branch.

**Quanto tempo até eu ser produtivo?** Não é medido. Espera-se que você entregue coisas pequenas na primeira semana e comece a pegar tarefa normal por volta da terceira.
