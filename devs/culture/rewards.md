...
Nada aqui substitui salário justo. Isso é o simbólico — e o simbólico só funciona quando o material está em dia. Se algum item desta página for usado como argumento para não corrigir remuneração, ele perdeu o sentido.
...
O que mais sustenta clima em time pequeno não é o evento grande, é o hábito pequeno:

- **Elogio específico e público.** "Bom trabalho" não vale nada. "O jeito que você isolou aquele bug de timezone economizou dois dias do time" vale muito.
- **Crédito na review.** Quem fez, apresenta. O gestor não demonstra o trabalho dos outros.
- **Autonomia como prêmio.** Quem mostra maturidade ganha decisão técnica, não só mais tarefas. Isso é o reconhecimento que devs sênior mais valorizam e o que empresas mais esquecem.

## O que evitamos de propósito

| Prática | Por que não |
|---|---|
| Ranking individual de produtividade | Destrói colaboração e code review honesto |
